...
namespace Assignment_5
{
    class Sales
    {
        ...
        static public void sales(int qt, Sales ob)
        {
            Console.WriteLine($"Total amount  {ob.Total_Amount = qt * ob.Price}");
        }
        public static void Main(String[] args)
        {
            Sales ob1 = new Sales(1, 1, 1500);
            Sales ob2 = new Sales(2, 2, 300);
            Sales ob3 = new Sales(3, 3, 500);
            Sales ob4 = new Sales(4, 4, 750);
            Sales ob5 = new Sales(5, 5, 950);
