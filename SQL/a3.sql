...
--12. List the name and salary of employees who earn more than 1500 and are 
--in department 10 or 30. Label the columns Employee and Monthly Salary respectively.
...
select ename ,sal*0.1 as 'inc salary' ,comm from emp where comm > sal--(select sal from emp where sal=sal*0.1)


--15. Display the name of all employees who have two Ls in their name and are in 
--department 30 or their manager is 7782. 
select ename from emp where ename like '%ll%' and (deptno=30 or mgr_id=7789)
