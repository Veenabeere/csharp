...
namespace connection
{
    ...
    class Program
    {
        ...
        {
            con = new SqlConnection("Data Source=ICS-LT-4PW29C3;Initial Catalog=casestudy;" +
                "integrated Security=true");
            con.Open();
            return con;
        }

        static void DataSelectS()
        {
            con = Makeconnection();
